...
class UBooking extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // Initialize form fields with the received service details or empty values
      name: props.location.state?.service?.name || '',
      mobileNumber: props.location.state?.service?.mobileNumber || '',
      address: props.location.state?.service?.address || '',
      duration: props.location.state?.service?.duration || '',
      date: props.location.state?.service?.date || '',
      description: props.location.state?.service?.description || '',
      patientName: '',
      altMobileNumber: '',
      selectedService: props.location.state?.service?.selectedService || '',
      errors: {},
