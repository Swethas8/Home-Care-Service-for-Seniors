import '../assest/css/AdminHome.css';
import { Link } from "react-router-dom";
import '@fortawesome/fontawesome-free/css/all.min.css'; 
import logo from '../assest/images/logo.png'; 
import img1 from '../assest/images/FAQ.png';
import img2 from '../assest/images/Policy.png';
import img3 from '../assest/images/Terms.png';
...
function AdminHome() {
  return (
    ...
    <nav >
      ...
      <li><a className="list">Logout</a></li>
    </nav>
  </header>
  <div id="home"> 
  ...
  <div className='overlay4'></div>
    ...
    <div className="hero-content-area">
      ...
      <Link to="/PostService"><a  className="btn">POST SERVICES</a></Link>
      ...
      <Link to="/AViewBooking"><a  className="btn">VIEW BOOKINGS</a></Link>
      <Link to="/AChangeStatus"><a  className="btn">CHANGE STATUS</a></Link>
