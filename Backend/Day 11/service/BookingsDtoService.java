...
public class BookingsDtoService {

    @Autowired
    private BookingsRepo bookingRepo;

    private BookingsDto convertEntityToDto(Bookings bookings) {
    ...
    public List<BookingsDto> getBookingsByName(String name) {
    ...
    //update by user
    public boolean updateBookings(String name, BookingsDto bookings) {
